...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.central_widget.setMaximumSize(QtCore.QSize(550, 16777215))
...
"}")
        ...
        self.comboBox_camera_sources.setMinimumSize(QtCore.QSize(185, 35))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.comboBox_type_cam = QtWidgets.QComboBox(self.frame)
        ...
        self.comboBox_type_cam.setMinimumSize(QtCore.QSize(175, 30))
        ...
        self.horizontalLayout.addWidget(self.comboBox_type_cam)
        ...
        self.comboBox_id_url_camera.setMinimumSize(QtCore.QSize(0, 32))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.media_path.setMinimumSize(QtCore.QSize(0, 32))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.btn_refresh.setMinimumSize(QtCore.QSize(45, 32))
        ...
        self.btn_load_media.setMinimumSize(QtCore.QSize(75, 32))
        ...
        self.label_4.setMinimumSize(QtCore.QSize(125, 34))
        self.label_4.setMaximumSize(QtCore.QSize(125, 34))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.comboBox_parameters.setMinimumSize(QtCore.QSize(0, 34))
        self.comboBox_parameters.setMaximumSize(QtCore.QSize(16777215, 34))
        ...
        self.btn_form_camera_params.setMinimumSize(QtCore.QSize(45, 34))
        self.btn_form_camera_params.setMaximumSize(QtCore.QSize(45, 34))
        ...
        self.btn_cancel.setMinimumSize(QtCore.QSize(80, 35))
        ...
        self.btn_ok.setMinimumSize(QtCore.QSize(55, 35))
        self.btn_ok.setMaximumSize(QtCore.QSize(55, 16777215))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btn_refresh.setText(_translate("Dialog", "R"))
        self.btn_load_media.setText(_translate("Dialog", "Open File"))
        self.label_4.setText(_translate("Dialog", "Select Parameter:"))
